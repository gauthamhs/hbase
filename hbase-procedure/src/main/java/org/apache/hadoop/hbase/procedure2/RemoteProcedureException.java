...
import org.apache.hadoop.hbase.protobuf.generated.ProcedureProtos.ProcedureExceptionMessage;
import org.apache.hadoop.hbase.protobuf.generated.ProcedureProtos.GenericExceptionMessage;
import org.apache.hadoop.hbase.protobuf.generated.ProcedureProtos.StackTraceElementMessage;
...
public class RemoteProcedureException extends IOException {
  ...
  /**
   * Create a new RemoteProcedureException that can be serialized.
   * It is assumed that this is locally
   * generated.
   * @param source
   * @param msg
   */
  public RemoteProcedureException(String source, String msg) {
  ...
  /**
   * The cause of a RemoteProcedureException can be an exception that was generated on a local in
   * process thread, or a thread from a 'remote' separate process.
   *
  ...
  public static ProcedureExceptionMessage toProto(String source, Throwable t) {
    ...
    List<StackTraceElementMessage> stack =
        RemoteProcedureException.toStackTraceElementMessages(t.getStackTrace());
    if (stack != null) {
      gemBuilder.addAllTrace(stack);
    }
    GenericExceptionMessage payload = gemBuilder.build();
    ProcedureExceptionMessage.Builder exception = ProcedureExceptionMessage.newBuilder();
    exception.setGenericException(payload).setSource(source);
    return exception.build();
  }

  public static RemoteProcedureException fromProto(final ProcedureExceptionMessage eem) {
    GenericExceptionMessage gem = eem.getGenericException();
    StackTraceElement [] trace = RemoteProcedureException.toStackTrace(gem.getTraceList());
    ProxyThrowable dfe = new ProxyThrowable(gem.getMessage(), trace);
    RemoteProcedureException e = new RemoteProcedureException(eem.getSource(), dfe);
    return e;
  }
  ...
  public static RemoteProcedureException deserialize(byte[] bytes)
    ...
    ProcedureExceptionMessage eem = ProcedureExceptionMessage.parseFrom(bytes);
