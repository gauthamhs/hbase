...
public class TestProcedureWAL {
  private static final Log LOG = LogFactory.getLog(TestProcedureWAL.class);
  ...
  public void testLoad() throws Exception {
    ...
    // Verify the everything is there
  ...
  private void verifyProcIdsOnRestart(final Set<Long> procIds) throws Exception {
    ...
    while (loader.hasNext()) {
      ...
      assertTrue(proc.getProcId() + " unexpected", procIds.contains(proc.getProcId()));
      count++;
    }
