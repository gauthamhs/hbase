...
public class TestZKProcedureControllers {
  ...
  public void testSimpleZKCohortMemberController() throws Exception {
    ...
    final ForeignExceptionSnare monitor = spy(new ForeignExceptionSnare());
    ...
    verify(monitor, never()).receiveError(Mockito.anyString(), Mockito.any(ForeignException.class),
      Mockito.any());
