...
public class TestRestoreLogrollSnapshotFromClient {
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    TEST_UTIL.getConfiguration().set(HConstants.HBASE_MASTER_LOGCLEANER_PLUGINS,
...
//  TEST_UTIL.startMiniCluster(3);
  ...
  public void setup() throws Exception {
    ...
    // take a snapshot
    admin.snapshot(Bytes.toString(snapshotName0), Bytes.toString(tableName), SnapshotDescription.Type.LOGROLL);
    ...
    admin.snapshot(Bytes.toString(snapshotName1), Bytes.toString(tableName), SnapshotDescription.Type.LOGROLL);
  ...
  @Test
  public void testTakeLogrollSnapshot() throws IOException {
  ...
  public void testRestoreSnapshotOfCloned() throws IOException, InterruptedException {
    ...
    assertEquals(snapshot0Rows, TEST_UTIL.countRows(table));
    admin.snapshot(Bytes.toString(snapshotName2), Bytes.toString(clonedTableName), SnapshotDescription.Type.LOGROLL);
