...
public class TestProcedureMember {
   ...
   */
  @Test(timeout = 1000)
  public void testMembersendMemberAcquiredCommsFailure() throws Exception {
    buildCohortMemberPair();
  ...
  public void testCoordinatorAbort() throws Exception {
    ...
    final TimeoutForeignException oate = new TimeoutForeignException("bogus timeout", 1,2,0);
    doAnswer(
        new Answer<Void>() {
          @Override
          public Void answer(InvocationOnMock invocation) throws Throwable {
  ...
  */
  ...
  public void testPropagateConnectionErrorBackToManager() throws Exception {
    ...
    doThrow(new ForeignException("prepare exception")).when(spy).acquireBarrier();
