...
abstract public class Subprocedure implements Callable<Void> {
  ...
  public Subprocedure(ProcedureMember member, String procName, ForeignExceptionDispatcher monitor,
    ...
    assert member != null : "procecure member should be non-null";
    ...
    // possible.
    this.monitor.addErrorListener(new ForeignExceptionListener() {
      @Override
      public void receiveError(String message, ForeignException ee, Object... args) {
   ...
   * exposed for testing.
   */
  ForeignExceptionCheckable getErrorCheckable() {
    return this.monitor;
  }
  ...
  public void cancel(String msg, Throwable cause) {
    ...
    if (cause instanceof ForeignException) {
      monitor.receiveError(msg, (ForeignException) cause);
    } else {
      monitor.receiveError(msg, new ForeignException(cause));
    }
  }
  ...
  void waitForReachedGlobalBarrier() throws ForeignException, InterruptedException {
    ForeignExceptionDispatcher.waitForLatch(inGlobalBarrier, monitor, wakeFrequency,
  ...
  public void waitForLocallyCompleted() throws ForeignException, InterruptedException {
    ForeignExceptionDispatcher.waitForLatch(releasedLocalBarrier, monitor, wakeFrequency,
