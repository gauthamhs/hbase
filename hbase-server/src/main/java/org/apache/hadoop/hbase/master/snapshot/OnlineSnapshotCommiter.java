...
/**
 * Handle all the distributed commit logic for a three-phase commit for a snapshot
 */
public class OnlineSnapshotCommiter {



  public OnlineSnapshotCommiter(ZooKeeperWatcher zkw, String nodeName, long wakeFrequency,
      long timeout, long keepAliveTime, int opThreads) throws KeeperException {
  }
