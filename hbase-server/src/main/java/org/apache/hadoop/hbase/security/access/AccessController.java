...
public class AccessController extends BaseRegionObserver
  ...
  public void preSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx,
    ...
    throw new IOException(new UnsupportedOperationException(
      "Snapshot operation is not supported yet with ACL enabled"));
  }
  ...
  public void preCloneSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx,
      ...
      throws IOException {
    throw new IOException(new UnsupportedOperationException(
      "Clone snapshot operation is not supported yet with ACL enabled"));
  }
  ...
  public void preRestoreSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx,
      ...
      throws IOException {
    throw new IOException(new UnsupportedOperationException(
      "Restore snapshot operation is not supported yet with ACL enabled"));
  }
  ...
  public void preDeleteSnapshot(final ObserverContext<MasterCoprocessorEnvironment> ctx,
    ...
    throw new IOException(new UnsupportedOperationException(
      "Delete snapshot operation is not supported yet with ACL enabled"));
  }
