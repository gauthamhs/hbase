 ...
 */
 ...
 public synchronized  byte[][] rollHLogWriter(String serverName)
  ...
  public void snapshot(final String snapshotName, final String tableName) throws IOException,
    ...
    snapshot(snapshotName, tableName, HBaseProtos.SnapshotDescription.Type.TIMESTAMP);
  }
   ...
   * @throws IllegalArgumentException if the snapshot request is formatted incorrectly
   */
  public void snapshot(HBaseProtos.SnapshotDescription snapshot) throws IOException, SnapshotCreationException,
      IllegalArgumentException {
    // make sure the snapshot is valid
    SnapshotDescriptionUtils.assertSnapshotRequestIsValid(snapshot);

    SnapshotDescription snapshotWritable = new SnapshotDescription(snapshot);
   ...
   */
  public boolean isSnapshotFinished(final HBaseProtos.SnapshotDescription snapshot)
      throws IOException, HBaseSnapshotException, UnknownSnapshotException {
    return getMaster().isSnapshotDone(new SnapshotDescription(snapshot));
  }
  ...
  public void restoreSnapshot(final String snapshotName)
    ...
    for (HBaseProtos.SnapshotDescription snapshotInfo: listSnapshots()) {
  ...
  private void internalRestoreSnapshot(final String snapshotName, final String tableName)
      throws IOException, RestoreSnapshotException {
    SnapshotDescription snapshot = new SnapshotDescription(
      HBaseProtos.SnapshotDescription.newBuilder().setName(snapshotName).setTable(tableName).build());
  ...
  public List<HBaseProtos.SnapshotDescription> listSnapshots() throws IOException {
    List<HBaseProtos.SnapshotDescription> snapshots = new LinkedList<HBaseProtos.SnapshotDescription>();
    for (SnapshotDescription snapshot: getMaster().listSnapshots()) {
  ...
  public void deleteSnapshot(final byte[] snapshotName) throws IOException {
    ...
    getMaster().deleteSnapshot(new SnapshotDescription(snapshot));
  }
