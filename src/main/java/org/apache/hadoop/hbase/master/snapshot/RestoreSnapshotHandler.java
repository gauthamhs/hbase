...
public class RestoreSnapshotHandler extends TableEventHandler implements SnapshotSentinel {
  ...
  protected void handleTableOperation(List<HRegionInfo> hris) throws IOException {
    ...
    try {
      ...
      LOG.error(msg, e);
      monitor.receiveError("Failed due to exception:" + e.getMessage(),
          new ForeignException(masterServices.getServerName().toString(), e));
  ...
  public void cancel(String why, Throwable t) {
    ...
    LOG.info(msg);
    this.monitor.receiveError("Failing restore because server is stopping.",
        new ForeignException(masterServices.getServerName().toString(), t));
  }
