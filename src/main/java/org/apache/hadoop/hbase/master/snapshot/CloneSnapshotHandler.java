...
public class CloneSnapshotHandler extends CreateTableHandler implements SnapshotSentinel {
  ...
  protected List<HRegionInfo> handleCreateRegions(String tableName) throws IOException {
    ...
    try {
      ...
      LOG.error(msg, e);
      ForeignException fe = new ForeignException("Master Clone Handler", e);
      this.monitor.receiveError("Failed due to exception:" + e.getMessage(), fe);
  ...
  public void cancel(String why, Throwable t) {
    ...
    LOG.info(msg);
    ForeignException fe = new ForeignException(msg, t);
    this.monitor.receiveError("Failing clone snapshot because server is stopping.", fe);
  }
