...
public class TestSnapshotFromMaster {
  ...
  public void testIsDoneContract() throws Exception {
    ...
    SnapshotTestingUtils.expectSnapshotDoneException(master, new SnapshotDescription(),
    ...
    SnapshotTestingUtils.expectSnapshotDoneException(master, new SnapshotDescription(desc),
      UnknownSnapshotException.class);
    ...
    boolean isDone = master.isSnapshotDone(new SnapshotDescription(desc));
    ...
    isDone = master.isSnapshotDone(new SnapshotDescription(desc));
    ...
    try {
      master.isSnapshotDone(new SnapshotDescription(desc));
  ...
  public void testListSnapshots() throws Exception {
    ...
    List<SnapshotDescription> snapshots = master.listSnapshots();
  ...
  public void testDeleteSnapshot() throws Exception {
    ...
    HBaseProtos.SnapshotDescription snapshot = HBaseProtos.SnapshotDescription.newBuilder()
      .setName(snapshotName).build();
    try {
      master.deleteSnapshot(new SnapshotDescription(snapshot));
