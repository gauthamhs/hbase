...
public class SnapshotTestingUtils {
   ...
   * the passed in parameters.
   */
  public static void assertOneSnapshotThatMatches(HBaseAdmin admin, HBaseProtos.SnapshotDescription snapshot)
      throws IOException {
    assertOneSnapshotThatMatches(admin, snapshot.getName(), snapshot.getTable());
  }
   ...
   * the passed in parameters.
   */
  public static List<HBaseProtos.SnapshotDescription> assertOneSnapshotThatMatches(HBaseAdmin admin,
   ...
   */
  public static void confirmSnapshotValid(HBaseProtos.SnapshotDescription snapshotDescriptor, 
   ...
   */
  public static void expectSnapshotDoneException(HMaster master, SnapshotDescription snapshot,
      Class<? extends HBaseSnapshotException> clazz) {
    try {
      master.isSnapshotDone(snapshot);
